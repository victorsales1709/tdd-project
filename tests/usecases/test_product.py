...
async def test_usecases_get_should_return_sucess(product_id, product_in):
...
async def test_usecases_update_should_return_sucess(product_id, product_update):
    ...
    result = await product_usecase.update(id=product_id, body=product_update)
